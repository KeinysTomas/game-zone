...
<div class="container-lg homeSection gx-0"> 
  <div class="video-wrapper"> 
    ...
    <p class="home-subtitle">Welcome To</p>
    
    <h1 class="home-title fw-bold">GAME ZONE</h1> 
</div>
...
<div class="container-lg ps-3 pe-3     pt-1 pb-0   pt-lg-5 pb-lg-4       ps-md-5  pe-md-5 home" >
  ...
  <div class="rowhome">
  <div class="col-xl-4 col-lg-5 col-md-6 col-sm-7 col-10 mr-auto wpb_column vc_column_container vc_col-sm-6 col-12">
...
.allwidth {
  background-image: url('../assets/vortex-long-5opacity.png');
